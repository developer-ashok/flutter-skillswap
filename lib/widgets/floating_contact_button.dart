        ...
        child: Column(
          ...
          children: [
            ...
            _buildContactItem(
              ...
              title: 'Phone',
              value: '+91 9033359874',
              onTap: () => _launchUrl('tel:+919033359874'),
            ),
            const SizedBox(height: 12),
            _buildContactItem(
              icon: Icons.email,
              title: 'Email',
              value: 'developer7039@gmail.com',
              onTap: () => _launchUrl('mailto:developer7039@gmail.com'),
            ),
            const SizedBox(height: 12),
            _buildContactItem(
              icon: Icons.link,
              title: 'GitHub',
              value: 'github.com/developer-ashok',
            ...
            _buildContactItem(
              icon: Icons.work,
              title: 'LinkedIn',
              value: 'linkedin.com/in/ashok-chandrapal',
              onTap: () => _launchUrl('https://linkedin.com/in/ashok-chandrapal'),
            ),
            const SizedBox(height: 20),
